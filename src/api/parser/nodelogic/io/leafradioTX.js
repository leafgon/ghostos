...
/*
 * _leafradioTX() is a dataflow-plane-scoped function for the LEAF node of logic type 'leafradioTX'.
 * it is used to declare a wireless dataflow communication transmitter in a dataflow-scoped leaf component graph.
 */
const _leafradioTX = {
