...
const { _leafmemoryio, _leafinflowport } = require('../../../../../ghostos/api/parser/nodelogic/io');
...
//      "data":"eyJsZWFmIjp7ImxvZ2ljIjp7InR5cGUiOiJsZWFmc3BlbGxkZWYiLCJhcmdzIjp7InNwZWxsbmFtZSI6Imxpc3RsaWIiLCJzdmdpY29uIjp7InVybCI6IiJ9fX0sImFwaSI6ImJyZWV6eWZvcmVzdCIsImFwcGRhdGEiOnsicG9zaXRpb24iOnsieCI6NDgsInkiOjYwOH19fX0="
  ...
  test("testing leafinflowport dataflow function", async () => {
    // actual test
    const mode = "nav";
    const domain = "spark";
    ...
    const dataflowlogic = await _leafinflowport.dataflow(lambdactrl)({refnode: "b8f5dfa5-11ce-4374-814f-f740c54250a3", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
