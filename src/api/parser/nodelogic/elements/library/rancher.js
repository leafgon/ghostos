...
const raceConditionError = doBottle("error", {type: "critical", message: "LEAF core error: race condition detected in rancher.js", codebase:"/src/ghostos/api/parser/nodelogic/elements/library/rancher.js"}, {});
const cachekeys = {
    //URI: "_rancher_uri",
    //HEADER: "_rancher_header",
};
...
const initElementInterface = (_stream_cache) => {
    ...
    const _elementlogic = async (_data_in) => {
        ...
        const _uri = "https://www.leafgon.com/api/bf/element/rancher"
