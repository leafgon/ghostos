...
const { zipWith, tap, connect, map, concatMap, take, switchMap } = require('rxjs/operators');

const { _leafmemoryio } = require('../../../../../ghostos/api/parser/nodelogic/io');
const { _leafspell } = require('../../../../../ghostos/api/parser/nodelogic/abstraction');
...
describe("ghostos/api/parser function tests", () => {
  const nodes = [
    ...
    },
    {
      ...
      "out_edges":[{"uuid":"7a1ef83c-453f-4048-b90c-09a747290746","source":{"uuid":"bbc7ac86-88f4-4b4e-987b-db2df99b538e"},"target":{"uuid":"0f663e30-9691-4cc3-95ab-3a12a027bb8e"},"data":nodedataLUT.edges.data},{"uuid":"f9e3dc7c-df6a-4368-bb30-4ee0543cfa9d","source":{"uuid":"bbc7ac86-88f4-4b4e-987b-db2df99b538e"},"target":{"uuid":"a68ef576-7360-4fea-b695-b971413df2a0"},"data":nodedataLUT.edges.lambda}],
      "data": encodeNodeData(
    ...
    },
    {
      ...
      "out_edges":[],
      "data": encodeNodeData(
        {"leaf":{"logic":{"type":"leafspell","args":{"spellname":"testbed"}},"api":"breezyforest","appdata":{"position":{"x":0,"y":0}}},"domain":testdomain,"appid":testappid,"inputData":{},"isdebug":true,"selected":true}
      )
    }
  ];

  test("testing leafspell dataflow function", async () => {
    ...
    const dataflowlogic = await _leafspell.dataflow(lambdactrl)({refnode: "7871c31a-8564-44a0-bd0d-8b17da18653f", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
    ...
    //            outcache = typeof x === "string" ? x : JSON.stringify(x);
    //            delay$.next(true);
    //        },
    //    }
    //);
    output$obj._control._stream.pipe(
        switchMap(x => {
    ...
    expect(outcache).toBe('4');
    
  });

  test("testing leafspell dataflow of breezyforest/editormenu function", async () => {
    jest.setTimeout(100000);
    // actual test
    const mode = "nav";
    const domain = testdomain;
    ...
    leafnode_args.spellname = "listlib";
    const spelllib = await _leafspell.lambda(lambdactrl)({refnode: "7cd4d11d-8ad7-4ce4-bfc3-766ea6cb46ac", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
    const dataflowlogic = spelllib.menudata._default; // await _leafspell.dataflow(lambdactrl)({refnode: "7871c31a-8564-44a0-bd0d-8b17da18653f", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
    ...
    console.log(endingcredit);
    expect(outcache).toBe(JSON.stringify({
        _bname: "_leafdeckheart",
        _content: {
            type:"leafdeckheart",
            uuid:"43e6dae9-6dd5-4c6d-ba32-2c7f4eb6225c",
            name:"Hurley",
            ...
            diamonds: [{
                ...
                uuid:"d53ecd46-dfb3-4865-bb12-6151a35306fb",
                name:"wizardry",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
                    default:"defaultLambda"
                },
                clubs:[{
                    type:"leafdeckclub",
                    uuid:"8313b016-99e7-446e-a2de-07ec375b327f",
                    name:"leaflisp",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                ...
                {
                    type:"leafdeckdiamond",
                    uuid:"929d0e5c-3a55-4657-8d6b-eda65d1865ad",
                    name:"i/o",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                    ...
                    clubs:[{
                        type:"leafdeckclub",
                        uuid:"e400df93-dca8-47f2-9295-0ce12a75fed7",
                        name:"outport",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"00baa45a-d2c2-4e89-a8c6-c2ddb30ca43b",
                        name:"inport",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"502a25bb-598d-45ba-a865-5c30c71c4f90",
                        name:"screenio",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"fd6a3844-15ae-40ec-933a-eb26d0d3ec92",
                        name:"memoryio",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                ...
                {
                    type:"leafdeckdiamond",
                    uuid:"23d4f4cd-c117-49eb-8321-7c9440920cbf",
                    name:"elements",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                    ...
                    clubs:[{
                        type:"leafdeckclub",
                        uuid:"7780409d-4350-4b74-8608-6ea4b0db1381",
                        name:"element",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"fada5a34-ff1e-4cd5-a825-b49c23eb2fd5",
                        name:"spade",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"de0a040b-6a89-434f-8e7c-6a242f4b1a09",
                        name:"heart",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"553e7ada-7d65-4fe2-b382-4fdb872b40df",
                        name:"diamond",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
                    ...
                    {
                        type:"leafdeckclub",
                        uuid:"e0467a55-9a98-4c62-b59f-26dd3c994282",
                        name:"club",
                        svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                        description:"{description}",
                        lambdas:{
            ...
            {
                type:"leafdeckdiamond",
                uuid:"3d4d2eef-29de-49db-8e52-93fca0d4fca3",
                name:"abstraction",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
                ...
                clubs:[{
                    type:"leafdeckclub",
                    uuid:"2b6069a9-99c7-4fa8-bc94-2091ca900e64",
                    name:"loopyspell",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                ...
                {
                    type:"leafdeckclub",
                    uuid:"f460a716-6a5c-4a08-af97-b4fa20e60122",
                    name:"spell",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                ...
                {
                    type:"leafdeckclub",
                    uuid:"e177fdd9-90a5-4abf-8602-a1109d7818ad",
                    name:"spelldef",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                ...
                {
                    type:"leafdeckclub",
                    uuid:"76a0b884-e2db-4a2e-88ba-50b2f905c720",
                    name:"lambda",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                ...
                {
                    type:"leafdeckclub",
                    uuid:"d0803e04-a304-49fa-adaa-85649a300144",
                    name:"leafgraph",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
                ...
                {
                    type:"leafdeckclub",
                    uuid:"b5210315-0c4e-4649-b563-bd128c5c32ce",
                    name:"anchor",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
        ...
        {
            type:"leafdeckdiamond",
            uuid:"9906d41a-f332-41f5-8a4c-5331faa98b4c",
            name:"utility",
            svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
            description:"{description}",
            lambdas:{
            ...
            clubs:[{
                type:"leafdeckclub",
                uuid:"f8e1f91d-ac8b-42c8-a4b5-de3881da612a",
                name:"unbottle",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"d4a3f75d-9952-4c7e-a7ef-cff68907be4d",
                name:"bottle",
                svgicon: "http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"95eb6566-a4e1-49cb-885b-b0a96aebd487",
                name:"crate",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"246745dc-3d34-4495-828d-0947cbdcc605",
                name:"delabel",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"e361c7bc-c9a6-4212-bcac-d1965e10db1c",
                name:"label",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"88464b46-b1a7-41d3-80f1-859db1eee309",
                name:"mix",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"30c397a1-6b43-4bcb-929c-e748f19d1cbb",
                name:"gate",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"cb61cbe9-5cb5-460f-ab1a-cd79cec2eb0d",
                name:"sync",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
            ...
            {
                type:"leafdeckclub",
                uuid:"c3e7100d-32dd-4d5f-946e-23f71016e599",
                name:"config",
                svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                description:"{description}",
                lambdas:{
  ...
  test("testing leaflisp dataflow of breezyforest/leaflisp functions", async () => {
    jest.setTimeout(100000);
    // actual test
    const mode = "nav";
    const domain = testdomain;
    ...
    leafnode_args.spellname = "listlib";
    const spelllib = await _leafspell.lambda(lambdactrl)({refnode: "7cd4d11d-8ad7-4ce4-bfc3-766ea6cb46ac", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
    const dataflowlogic = spelllib.leaflisp.leaflisp._default; // await _leafspell.dataflow(lambdactrl)({refnode: "7871c31a-8564-44a0-bd0d-8b17da18653f", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
    ...
    expect(outcache).toBe(JSON.stringify(
        {
            ...
            _content:{
                type:"leafdeckheart",
                uuid:"07cd6ca3-4a5f-49d2-b222-c7b0b18ef79a",
                name:"Leon",
                description:"{description}",
                lambdas:{
                    default:"defaultLambda"
                ...
                diamonds:[{
                    type:"leafdeckdiamond",
                    uuid:"0782f6ca-ea5a-415c-ad97-75a705e73817",
                    name:"editor",
                    svgicon:"http://localhost/icons/hardware/laptop_mac/materialicons/24px.svg",
                    description:"{description}",
                    lambdas:{
  ...
  test("testing vim dataflow of breezyforest/leaflisp functions", async () => {
    jest.setTimeout(100000);
    // actual test
    const mode = "nav";
    const domain = testdomain;
    ...
    leafnode_args.spellname = "listlib";
    const spelllib = await _leafspell.lambda(lambdactrl)({refnode: "7cd4d11d-8ad7-4ce4-bfc3-766ea6cb46ac", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
    const dataflowlogic = spelllib.leaflisp.vim._default; // await _leafspell.dataflow(lambdactrl)({refnode: "7871c31a-8564-44a0-bd0d-8b17da18653f", refnodedata: {leaf: {logic: {args: leafnode_args}}}, nodelambda: [], contextuallambda: []});
