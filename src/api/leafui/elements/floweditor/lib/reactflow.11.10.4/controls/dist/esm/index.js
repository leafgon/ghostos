...
// spark_dev_note: a hack to make it work when bypassing npm install to use source downloaded from github repo
import { useStoreApi, useStore, useReactFlow, Panel } from '../../../core/dist/esm';
...
function PlusIcon() {
  ...
  return <img src='/assets/svg/editor_control_zoomin.svg' style={{ height: 25, width: 25, opacity: 0.8 }} />
}

function MinusIcon() {
  //  return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 5" },
  //      React.createElement("path", { d: "M0 0h32v4.2H0z" })));
  return <img src='/assets/svg/editor_control_zoomout.svg' style={{ height: 25, width: 25, opacity: 0.8 }} />
}
...
function FitViewIcon() {
  ...
  return <img src='/assets/svg/editor_control_zoomfit.svg' style={{ height: 25, width: 25, opacity: 0.8 }} />
}
...
function LockIcon() {
  ...
  return <img src='/assets/svg/editor_control_lock.svg' style={{ height: 25, width: 25, opacity: 0.8 }} />
}
...
function UnlockIcon() {
  ...
  return <img src='/assets/svg/editor_control_unlock.svg' style={{ height: 25, width: 25, opacity: 0.8 }} />
}
...
const Controls = ({ style, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children, position = 'bottom-left', }) => {
    ...
    return (React.createElement(Panel, { className: cc(['react-flow__controls', className]), position: position, style: style, "data-testid": "rf__controls" },
        ...
        showInteractive && (React.createElement(ControlButton, { className: "react-flow__controls-interactive", onClick: onToggleInteractivity, title: "edit lock", "aria-label": "edit lock" }, isInteractive ? React.createElement(UnlockIcon, null) : React.createElement(LockIcon, null))),
        children));
};
