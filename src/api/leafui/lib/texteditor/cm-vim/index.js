import { EditorSelection, MapMode, Prec, StateEffect, StateField } from '@codemirror/state';
...
import { indentMore, indentLess, cursorCharLeft, insertNewlineAndIndent, indentSelection, deleteCharBackward, deleteCharForward } from '@codemirror/commands';
...
CodeMirror.commands = {
    ...
    redo: function (cm) { history.redo(cm.cm6); },
    undo: function (cm) { history.undo(cm.cm6); },
